      ...
      <NoticeContentsWrapper>
        <NoticeContents>
          <li>
            ...
            해당 정보는 mcm-js의 데이터베이스에 저장됩니다.
          </li>
          <li>
            아이피 주소 외에는 추가적인 개인 정보를 수집하지 않습니다.
          </li>{" "}
          <li>
          ...
          <li>
            개인정보 보호 및 데이터 처리에 대한 자세한 내용은 우리의 개인정보
            보호 정책을 참조해주시기 바랍니다.
          </li>
          <li>
            개인정보 수집 약관에 동의하지 않을 시 댓글 등록이 불가하며, mcm-js의
            모든 댓글 등록은 사용자가 개인정보 수집 약관에 동의함으로
            간주합니다.
          </li>
        </NoticeContents>
      </NoticeContentsWrapper>
