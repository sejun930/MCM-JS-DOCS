...
export const modalExampleList = (idx?: number): Array<ExampleIProps> => {
  const _modalCodeList = modalCodeList[idx || 0];
  ...
  return [
    ...
    },
    {
      ...
      contents: [
        {
          remakrs:
            "width 300px, height : 300px 크기의 모달을 만들 수 있습니다.",
          addProps: {
            ...modalExampleInitProps,
        ...
        },
        {
          ...
          code: _modalCodeList.sizePercent,
        },
      ],
    },
    {
      ...
      contents: [
        {
          ...
          code: _modalCodeList.responsive,
        },
      ],
    },
    {
      ...
      contents: [
        {
          ...
          code: _modalCodeList.hideCloseButton,
        },
        {
          ...
          code: _modalCodeList.addCloseMent,
        },
        {
      ...
      contents: [
        {
          ...
          code: _modalCodeList.offAutoClose,
        },
      ],
    },
    {
