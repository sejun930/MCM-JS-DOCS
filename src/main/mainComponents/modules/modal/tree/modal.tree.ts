...
export const modalTreeList: Array<TreeModuleListTypes> = [
  ...
  },
  {
    tag: "div",
    class:
      classList?.modal?.closeButtonWrapper || "mcm-modal-close-button-wrapper",
    depth: 2,
  ...
  },
  {
    tag: "button",
    class:
      classList?.modal?.closeButtonMentButton || "mcm-modal-close-ment-button",
    depth: 3,
    role: "닫기에 관한 설명을 감싸는 버튼 태그입니다. <br /><b>closeMent</b>가 전달될 때만 화면에 노출되며 <br />클릭하면 <b>onCloseModal</b> 이벤트가 작동됩니다.",
  },
  {
    tag: "span",
    class: classList?.modal?.closeButtonMent || "mcm-modal-close-ment",
    depth: 4,
    role: "닫기에 관한 설명을 나타내는 태그입니다. <br /><b>closeMent</b>로 전달받은 문자열이 노출됩니다.",
  },
  {
    tag: "button",
    class: classList?.modal?.closeButton || "mcm-modal-close-button",
    depth: 3,
  ...
  {
    tag: "div",
    class: classList?.modal?.contents || "mcm-modal-contents",
    depth: 2,
