...
const alertFunctionalList: Array<FunctionalListType> = [
    ...
    props: {
      list: [
        funcExampleForm({
          name: "sequence",
          notice:
            "기입한 순서에 실행된 Alert을 종료시킵니다. <br /> <b>(ex : 1 -> 1번째로 실행된 Alert 종료)</b>",
          type: "Number",
          _default: "0",
        ...
        funcExampleForm({
          name: "className",
          notice: "해당 클래스 선택자 값으로 실행된 Alert을 모두 종료합니다.",
          type: "Object",
          _default: '{ className : "" }',
        ...
        funcExampleForm({
          name: "id",
          notice: "해당 아이디 선택자 값으로 실행된 Alert 한개를 종료합니다.",
          type: "Object",
          _default: '{ id : "" }',
          children: getCommonsHighlight.curly({
            className: "yellow",
    ...
    exampleCode: funcForm({
      ...
      props: `
        ...
        getCommonsHighlight.colors(
          '화면 전체의 "Test" ClassName을 가지는 모든 Alert을 종료합니다.'
        ).comment
      }
        `,
    }),
  ...
  },
  {
    ...
    remakrs: "실행되어 있는 모든 Alert을 조건에 상관없이 모두 종료합니다.",
    props: { list: [] },
    exampleCode: funcForm({
