...
export const alertTreeList: Array<TreeModuleListTypes> = [
  {
    ...
    depth: 0,
    role: "알럿 전체를 감싸는 태그입니다. <br />알럿의 크기 및 테두리 스타일을 담당합니다. <br /><br />전달받은 <b>className</b> 또는 <b>id</b>가 선택자로 지정됩니다. <br /><br /><b>alertConcept.custom.color</b>로 색상을 전달받으면 <br />테두리의 색상이 변경됩니다. <br /><br /><b>alertStyles</b> 또는 <b>alertResponsiveStyles</b>로 전달받은 스타일이 <br />직접 적용되는 태그입니다.",
  },
  {
    tag: "div",
  ...
  },
  {
    ...
    depth: 2,
    role: "알럿의 컨셉 이모지를 나타내는 태그입니다. <br /><b>alertConcept.type</b>이 지정되어야 노출되는 태그입니다. <br /> <br /><b>alertConcept.custom.color</b>로 전달받은 색상으로 <br />테두리 및 이모지 색상을 변경할 수 있고 <br /><br /><b>alertConcept.custom.icon</b> 객체를 통해 <br />이모지 경로, 색상, 크기를 직접 변경할 수 있습니다. <br /><br /><b>alertConcept.custom.icon.color</b>로 전달된 색상은 <br /><b>alertConcept.custom.color</b> 색상보다 우선순위로 지정됩니다.",
  },
  {
    tag: "span",
