...
export const tooltipTreeList: Array<TreeModuleListTypes> = [
  ...
  {
    tag: "div",
    class: tooltipClassList?.textWrapper || "mcm-tooltip-text-wrapper",
    depth: 2,
  ...
  {
    tag: "div",
    class: tooltipClassList?.textContents || "mcm-tooltip-text-contents",
    depth: 3,
  ...
  {
    tag: "span",
    class: tooltipClassList?.text || "mcm-tooltip-text",
    depth: 4,
